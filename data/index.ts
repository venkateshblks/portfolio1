...
export const projects = [
  ...
  {
    id: 4,
    title: "Artificial Neural Networks on Alphabets Data",
...
export const workExperience = [
  {
    id: 1,
    title: "Data Science",
    desc: "Analyzed large datasets using Python to extract actionable insights, driving a 15% increase in operational efficiency.Developed and deployed machine learning models to predict customer behavior, enhancing marketing strategies and customer retention.",
  ...
  },
  {
    id: 2,
    title: "web developer",
    desc: "Developed responsive web pages using HTML, CSS, JavaScript, React, Express, and Python, improving site performance by 20%.",
